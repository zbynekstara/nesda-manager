...
public class Judge {
    ...
    private BinarySearchTree encounteredJudgeTree = new BinarySearchTree(); // populated by the allocation algorithm
    private BinarySearchTree blockedJudgeTree = new BinarySearchTree(); // populated after allocation according to room situation

    //private BinarySearchTree encounteredJudgeTempIDTree = new BinarySearchTree();
    ...
    /*public void insertEncounteredJudgeTempID(int tempID) throws IllegalArgumentException {
        encounteredJudgeTempIDTree.insert(tempID, tempID + "");
    }*/

    /*public int getEncounteredJudgeTempID(int index) {
        int currentEncounteredJudgeTempID = (Integer) encounteredJudgeTempIDTree.getNodeData(index);
        return currentEncounteredJudgeTempID;
    }*/

    /*public int getEncounteredJudgeTempIDTreeSize() {
        return encounteredJudgeTempIDTree.size();
    }*/

    /*public void insertEncounteredJudge(Judge judge) throws IllegalArgumentException {
