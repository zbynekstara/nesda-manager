...
public class MainGUI extends javax.swing.JFrame {
        ...
        if (approvedSectionsIndex >= 2) {
            ...
            while (true) {
                ...
                if (currentLine == null) {
                    ...
                    QualificationEvent currentEvent = qualification.getEventArrayElement(currentEventIndex);
                    ...
                    try {
                        currentRound.removeFreeJudge(roomJudge);
                        currentRoom.allocateJudge(roomJudge, currentRoundIndex);
                    } catch (IllegalArgumentException ex) {
                        throw new FileIOException();
                    } catch (NoSuchElementException ex) {
                        throw new FileIOException();
                    ...
                    try {
                        currentRound.removeFreeEntity(roomEntity);
                        currentRoom.allocateEntity(roomEntity, currentRoundIndex);
                    } catch (IllegalArgumentException ex) {
                        throw new FileIOException();
                    } catch (NoSuchElementException ex) {
                        throw new FileIOException();
        ...
        if (saveDialogReturn == JFileChooser.APPROVE_OPTION) {
            ...
            if (approvedSectionsIndex >= 2) {
                ...
                for (int i = 0; i < qualification.getEventArrayLength(); i++) {
                    QualificationEvent currentEvent = qualification.getEventArrayElement(i);
    ...
    /**
     * This method updates the string of the qualificationProgressBar.
     *
     * @param string new String for the qualificationProgressBar
     *
     * @author Zbyněk Stara
     */
    private void editQualificationProgressBar(String string) {
        qualificationProgressBar.setString("Progress ("+string+")");
    }

    /**
     * This method resets the string of the qualificationProgressBar.
     *
     * @author Zbyněk Stara
     */
    private void resetQualificationProgressBar() {
    ...
    private void updateEventsListModel() {
        ...
        QualificationEvent[] eventArray = qualification.getEventArray();
    ...
    /**
     * This method updates the qualificationScoresListModel to display the
     * scores of a specified entity in current round, as specified by the
     * roundsIndex.
     *
     * @param currentEntity the entity whose scoresArray will serve as a basis for
     * this listModel.
     * @throws NullPointerException if the currentEntity supplied is null or if
     * roundsIndex is not a valid round index.
     *
     * @author Zbyněk Stara
     */
    private void updateScoresListModel(Entity currentEntity) throws NullPointerException {
        DefaultListModel model = new DefaultListModel();

        int [] qualificationScoresArray = currentEntity.getQualificationScoresArray(roundsIndex);

        for (int i = 0; i < qualificationScoresArray.length; i++) {
            model.addElement(qualificationScoresArray[i]);
        }

        qualificationScoresList.setModel(model);
    }
    ...
    private void disableQualificationTabActionBox() {
        ...
        //qualificationRoundsList.setSelectedIndex(-1);
        qualificationRoundsList.setModel(blankModel);
        ...
        //qualificationScores.setSelectedIndex(-1);
        qualificationScoresList.setModel(blankModel);

        qualificationScoresTextField.setText("");
    ...
    private void enableQualificationTabActionBox() {
        ...
        qualificationScoresList.setModel(noSelectionModel);
    ...
    private void initComponents() {
        ...
        allocationInfoTextField.setFont(new java.awt.Font("Courier", 0, 13));
        ...
        allocationInfoTimeTextField.setFont(new java.awt.Font("Courier", 0, 13));
        ...
        participantsSchoolsTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                participantsSchoolsTextFieldActionPerformed(evt);
            }
        });
        ...
        participantsTeachersTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                participantsTeachersTextFieldActionPerformed(evt);
            }
        });
        ...
        participantsStudentsTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                participantsStudentsTextFieldActionPerformed(evt);
            }
        });
        ...
        qualificationScoresTextField.setEnabled(false);
        qualificationScoresTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                qualificationScoresTextFieldActionPerformed(evt);
            }
        });
        qualificationPane.add(qualificationScoresTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 44, 174, -1));

        qualificationScoresList.setEnabled(false);
        qualificationScoresList.setFocusable(false);
        qualificationScoresList.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
                qualificationScoresListValueChanged(evt);
            }
        });
        ...
        qualificationScoresAddButton.setEnabled(false);
        qualificationScoresAddButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                qualificationScoresAddButtonMouseReleased(evt);
            }
        });
        ...
        qualificationScoresRemoveButton.setEnabled(false);
        qualificationScoresRemoveButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                qualificationScoresRemoveButtonMouseReleased(evt);
            }
        });
...
// SETTINGS TAB:
    ...
    private void settingsLoadButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_settingsLoadButtonMouseReleased
        if (settingsLoadButton.isEnabled()) {
            try { // try to load a file
                ...
                if (approvedSectionsIndex == 0) { // only settings
                    ...
                    this.resetQualificationProgressBar();
                    this.updateQualificationProgressBar(0);
                }
    ...
    private void settingsApproveToggleButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_settingsApproveToggleButtonMouseReleased
        if (settingsApproveToggleButton.isEnabled()) {
    ...
    private void settingsResetButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_settingsResetButtonMouseReleased
        if (settingsResetButton.isEnabled()) {
    ...
    private void settingsSaveToggleButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_settingsSaveToggleButtonMouseReleased
        if (settingsSaveToggleButton.isEnabled()) {
...
// PARTICIPANTS TAB:
    ...
    private void participantsSchoolsAddButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsSchoolsAddButtonMouseReleased
        if (participantsSchoolsAddButton.isEnabled()) {
    ...
    private void participantsSchoolsRemoveButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsSchoolsRemoveButtonMouseReleased
        if (participantsSchoolsRemoveButton.isEnabled()) {
    ...
    private void participantsSchoolsEditButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsSchoolsEditButtonMouseReleased
        if (participantsSchoolsEditButton.isEnabled()) {
    ...
    private void participantsSchoolsSearchButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsSchoolsSearchButtonMouseReleased
        if (participantsSchoolsSearchButton.isEnabled()) {
    ...
    private void participantsSchoolsListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_participantsSchoolsListValueChanged
        if (participantsSchoolsList.isEnabled()) {
    ...
    private void participantsTeachersAddButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsTeachersAddButtonMouseReleased
        if (participantsTeachersAddButton.isEnabled()) {
    ...
    private void participantsTeachersRemoveButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsTeachersRemoveButtonMouseReleased
        if (participantsTeachersRemoveButton.isEnabled()) {
            School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
    ...
    private void participantsTeachersEditButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsTeachersEditButtonMouseReleased
        if (participantsTeachersEditButton.isEnabled()) {
    ...
    private void participantsTeachersSearchButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsTeachersSearchButtonMouseReleased
        if (participantsTeachersSearchButton.isEnabled()) {
    ...
    private void participantsTeachersListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_participantsTeachersListValueChanged
        if (participantsTeachersList.isEnabled()) {
    ...
    private void participantsStudentsAddButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsStudentsAddButtonMouseReleased
        if (participantsStudentsAddButton.isEnabled()) {
    ...
    private void participantsStudentsRemoveButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsStudentsRemoveButtonMouseReleased
        if (participantsStudentsRemoveButton.isEnabled()) {
            School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
    ...
    private void participantsStudentsEditButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsStudentsEditButtonMouseReleased
        if (participantsStudentsEditButton.isEnabled()) {
    ...
    private void participantsStudentsSearchButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsStudentsSearchButtonMouseReleased
        if (participantsStudentsSearchButton.isEnabled()) {
    ...
    private void participantsStudentsListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_participantsStudentsListValueChanged
        if (participantsStudentsList.isEnabled()) {
            School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
    ...
    private void settingsAcceptDialogConfirmButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_settingsAcceptDialogConfirmButtonMouseReleased
        if (settingsAcceptDialogConfirmButton.isEnabled()) {
    ...
    private void settingsErrorDialogConfirmButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_settingsErrorDialogConfirmButtonMouseReleased
        if (settingsErrorDialogConfirmButton.isEnabled()) {
    ...
    private void exceptionDialogConfirmButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exceptionDialogConfirmButtonMouseReleased
        if (exceptionDialogConfirmButton.isEnabled()) {
    ...
    private void illegalActionDialogConfirmButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_illegalActionDialogConfirmButtonMouseReleased
        if (illegalActionDialogConfirmButton.isEnabled()) {
    ...
    private void participantsStudentCodesAssignCodesButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsStudentCodesAssignCodesButtonMouseReleased
        if (participantsStudentCodesAssignCodesButton.isEnabled()) {
            try {
                School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
    ...
    private void participantsStudentCodesSearchButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsStudentCodesSearchButtonMouseReleased
        if (participantsStudentCodesSearchButton.isEnabled()) {
    ...
    private void participantsStudentCodesListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_participantsStudentCodesListValueChanged
        ...
        if (participantsStudentCodesList.isEnabled()) {
            School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
    ...
    private void participantsAssignEventsAssignEventsButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsAssignEventsAssignEventsButtonMouseReleased
        if (participantsAssignEventsAssignEventsButton.isEnabled()) {
            School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
            Student currentStudent = (Student) currentSchool.getStudentTreeNodeData(studentsIndex);
    ...
    private void participantsAssignPairsEventsListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_participantsAssignPairsEventsListValueChanged
        if (participantsAssignPairsEventsList.isEnabled()) {
            School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
    ...
    private void participantsAssignPairsLeftListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_participantsAssignPairsLeftListValueChanged
        if (participantsAssignPairsLeftList.isEnabled()) {
            School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
    ...
    private void participantsAssignPairsRightListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_participantsAssignPairsRightListValueChanged
        if (participantsAssignPairsRightList.isEnabled()) {
    ...
    private void participantsAssignPairsPairButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsAssignPairsPairButtonMouseReleased
        if (participantsAssignPairsPairButton.isEnabled()) {
            School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
    ...
    private void participantsAssignPairsPairsListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_participantsAssignPairsPairsListValueChanged
        if (participantsAssignPairsPairsList.isEnabled()) {
    ...
    private void participantsAssignPairsRemovePairButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsAssignPairsRemovePairButtonMouseReleased
        if (participantsAssignPairsRemovePairButton.isEnabled()) {
            School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
    ...
    private void participantsAssignEventsOriginalOratoryCheckBoxMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsAssignEventsOriginalOratoryCheckBoxMouseReleased
        if (participantsAssignEventsOriginalOratoryCheckBox.isEnabled()) {
            School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
            Student currentStudent = (Student) currentSchool.getStudentTreeNodeData(studentsIndex);
    ...
    private void participantsAssignEventsOralInterpretationCheckBoxMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsAssignEventsOralInterpretationCheckBoxMouseReleased
        if (participantsAssignEventsOralInterpretationCheckBox.isEnabled()) {
            School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
            Student currentStudent = (Student) currentSchool.getStudentTreeNodeData(studentsIndex);
    ...
    private void participantsAssignEventsImpromptuSpeakingCheckBoxMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsAssignEventsImpromptuSpeakingCheckBoxMouseReleased
        if (participantsAssignEventsImpromptuSpeakingCheckBox.isEnabled()) {
            School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
            Student currentStudent = (Student) currentSchool.getStudentTreeNodeData(studentsIndex);
    ...
    private void participantsAssignEventsDuetActingCheckBoxMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsAssignEventsDuetActingCheckBoxMouseReleased
        if (participantsAssignEventsDuetActingCheckBox.isEnabled()) {
            School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
            Student currentStudent = (Student) currentSchool.getStudentTreeNodeData(studentsIndex);
    ...
    private void participantsAssignEventsDebateCheckBoxMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsAssignEventsDebateCheckBoxMouseReleased
        if (participantsAssignEventsDebateCheckBox.isEnabled()) {
            School currentSchool = (School) database.getSchoolTreeNodeData(schoolsIndex);
    ...
    private void participantsExportButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsExportButtonMouseReleased
        if (participantsExportButton.isEnabled()) {
            try {
    ...
    private void participantsResetButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsResetButtonMouseReleased
        if (participantsResetButton.isEnabled()) {
            Toolkit.getDefaultToolkit().beep();
    ...
    private void participantsApproveToggleButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsApproveToggleButtonMouseReleased
        if (participantsApproveToggleButton.isEnabled()) {
    ...
    private void participantsSaveToggleButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_participantsSaveToggleButtonMouseReleased
        if (participantsSaveToggleButton.isEnabled()) {
    ...
    private void resetWarningDialogConfirmButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resetWarningDialogConfirmButtonMouseReleased
        if (resetWarningDialogConfirmButton.isEnabled()) {
    ...
    private void resetWarningDialogCancelButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resetWarningDialogCancelButtonMouseReleased
        if (resetWarningDialogCancelButton.isEnabled()) {
            resetWarningDialog.setVisible(false);
    ...
    private void approveParticipantsDialogIgnoreButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_approveParticipantsDialogIgnoreButtonMouseReleased
        if (approveParticipantsDialogIgnoreButton.isEnabled()) {
            long time1 = System.currentTimeMillis();

            try {
                qualification.reinitialize();
    ...
    private void approveParticipantsDialogCancelButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_approveParticipantsDialogCancelButtonMouseReleased
        if (approveParticipantsDialogCancelButton.isEnabled()) {
            approveParticipantsDialog.setVisible(false);
...
// QUALIFICATION TAB:
    ...
    private void qualificationEventsListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_qualificationEventsListValueChanged
        if (qualificationEventsList.isEnabled()) {
            eventsIndex = qualificationEventsList.getSelectedIndex();

            if (eventsIndex != -1) { // if events index was set to be something (not -1)
                QualificationEvent currentEvent = qualification.getEventArrayElement(eventsIndex);
                ...
                this.editQualificationProgressBar(currentEvent.getTypeEventName());

                int progress = (int) currentEvent.getNumQualificationScoresPercentage();
                this.updateQualificationProgressBar(progress);
            } else {
                qualificationRoundsList.setEnabled(false);
                qualificationRoundsList.setModel(noSelectionModel);
            ...
            qualificationScoresList.setEnabled(false);
            //qualificationScoresList.setSelectedIndex(-1);
            qualificationScoresList.setModel(noSelectionModel);
    ...
    private void qualificationRoundsEditNameButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_qualificationRoundsEditNameButtonMouseReleased
        if (qualificationRoundsEditNameButton.isEnabled()) {
            QualificationEvent currentEvent = qualification.getEventArrayElement(eventsIndex);
    ...
    private void qualificationRoundsListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_qualificationRoundsListValueChanged
        if (qualificationRoundsList.isEnabled()) {
    ...
    private void qualificationRoomsEditNameButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_qualificationRoomsEditNameButtonMouseReleased
        if (qualificationRoomsEditNameButton.isEnabled()) {
            QualificationEvent currentEvent = qualification.getEventArrayElement(eventsIndex);
            Round currentRound = currentEvent.getRoundArrayElement(roundsIndex);
    ...
    private void qualificationRoomsListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_qualificationRoomsListValueChanged
        if (qualificationRoomsList.isEnabled()) {
    ...
    private void qualificationJudgesSubstituteJudgeButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_qualificationJudgesSubstituteJudgeButtonMouseReleased
        if (qualificationJudgesSubstituteJudgeButton.isEnabled()) {
            if (judgesIndex != -1) { // if rounds index was set to be something (not -1)
                QualificationEvent currentEvent = qualification.getEventArrayElement(eventsIndex);
                Round currentRound = currentEvent.getRoundArrayElement(roundsIndex);
                Room currentRoom = currentRound.getRoomArrayElement(roomsIndex);
                Judge currentJudge = (Judge) currentRoom.getJudgeTreeNodeData(judgesIndex); // the judge to be replaced

                System.out.println("Current judge (to be replaced): " + currentJudge.toString());

                Judge substituteJudge = null; // the judge that will be replacing

                boolean substituteJudgeFound = false;
                boolean getNewSubstituteJudge = false;
                for (int i = 0; i < currentRound.getFreeJudgeTreeSize(); i++) {
                    substituteJudge = currentRound.getFreeJudgeTreeNodeData(i); // the judge to replace currentJudge
                    System.out.println("\t("+i+") Substitute judge (replacing): " + substituteJudge.toString());

                    for (int j = 0; j < currentRoom.getJudgeTreeSize(); j++) {
                        Judge otherJudge = (Judge) currentRoom.getJudgeTreeNodeData(j); // judges currently in the room
                        System.out.println("\t\t("+j+") Other judge (comparing): " + otherJudge.toString());

                        if (otherJudge.getID() == currentJudge.getID()) { // if the judge is the judge to be replaced, check others
                            System.out.println("\t\t\tThis judge is going to be replaced. Continuing.");
                            continue;
                        } else if (otherJudge.isJudgeBlocked(substituteJudge)) { // if the replacing judge is blocked by this judge, get another
                            System.out.println("\t\t\tThe substitute judge is blocked by the other judge!");
                            getNewSubstituteJudge = true;
                            break;
                        } else if (substituteJudge.isJudgeBlocked(otherJudge)) { // if the replacing judge blocks this judge, get another
                            System.out.println("\t\t\tThe substitute judge blocks the other judge!");
                            getNewSubstituteJudge = true;
                            break;
                        } else if (otherJudge.isJudgeEncountered(substituteJudge)) { // if the replacing judge was encountered by this judge, get another
                            System.out.println("\t\t\tThe substitute judge was encountered by the other judge!");
                            getNewSubstituteJudge = true;
                            break;
                        } else if (substituteJudge.isJudgeEncountered(otherJudge)) { // if the replacing judge has encountered this judge, get another
                            System.out.println("\t\t\tThe substitute judge has encountered the other judge!");
                            getNewSubstituteJudge = true;
                            break; // ADDED
                        } else {
                            System.out.println("\t\t\tNo problem. Continuing.");
                            getNewSubstituteJudge = false;
                            continue;
                        }
                    }

                    if (getNewSubstituteJudge) {
                        System.out.println("\t\tGetting a new substitute judge.");
                        continue; // try another substitute judge
                    } else {
                        System.out.println("\t\tThe substitute judge had no problem with other judges. Checking entities.\n");
                    }

                    for (int j = 0; j < currentRoom.getEntityTreeSize(); j++) {
                        Entity currentEntity = (Entity) currentRoom.getEntityTreeNodeData(j);
                        System.out.println("\t\t("+j+") Current entity: " + currentEntity.toString());

                        if (currentEntity.isJudgeBlocked(substituteJudge)) { // if this entity blocks the replacing judge
                            System.out.println("\t\t\tCurrent entity blocks the substitute judge!");
                            getNewSubstituteJudge = true;
                            break;
                        } else if (currentEntity.isJudgeEncountered(substituteJudge)) { // if this entity has encountered the replacing judge
                            System.out.println("\t\t\tCurrent entity has encountered the substitue judge!");
                            getNewSubstituteJudge = true;
                            break;
                        } else {
                            System.out.println("\t\t\tNo problem. Continuing.");
                    ...
                    if (getNewSubstituteJudge) {
                        ...
                        System.out.println("\t\tSubstitute judge found. Breaking the loop.\n");
                        substituteJudgeFound = true;
                        break;
                    }
                }

                if (substituteJudgeFound) {
                    currentRoom.removeJudge(currentJudge, roundsIndex);
                    currentRoom.allocateJudge(substituteJudge, roundsIndex);

                    currentRound.removeFreeJudge(substituteJudge);
                    currentRound.addFreeJudge(currentJudge);

                    int[] searchIndices = currentRound.searchJudge(substituteJudge.getID());
                    int searchedJudgeIndex = searchIndices[1];

                    this.updateJudgesListModel(currentRoom);
                    qualificationJudgesList.setSelectedIndex(searchedJudgeIndex);
                    qualificationJudgesList.ensureIndexIsVisible(searchedJudgeIndex);
                } else {
                    System.out.println("\t\tNo suitable judge was found!\n");
    ...
    private void qualificationJudgesListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_qualificationJudgesListValueChanged
        if (qualificationJudgesList.isEnabled()) {
            judgesIndex = qualificationJudgesList.getSelectedIndex();

            if (judgesIndex != -1) { // if judges index was set to be something (not -1)
                QualificationEvent currentEvent = qualification.getEventArrayElement(eventsIndex);
                Round currentRound = currentEvent.getRoundArrayElement(roundsIndex);
                Room currentRoom = currentRound.getRoomArrayElement(roomsIndex);
    ...
    private void qualificationStudentCodesSearchButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_qualificationStudentCodesSearchButtonMouseReleased
        if (qualificationStudentCodesSearchButton.isEnabled()) {
    ...
    private void qualificationStudentCodesListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_qualificationStudentCodesListValueChanged
        if (qualificationStudentCodesList.isEnabled()) {
            ...
            if (qStudentCodesIndex != -1) { // if rounds index was set to be something (not -1)
                ...
                if (currentEntity.qualificationScoresAllocated(roundsIndex)) {
                    qualificationScoresList.setEnabled(true);
                    this.updateScoresListModel(currentEntity);
                } else {
                    qualificationScoresList.setEnabled(false);
                    //qualificationScoresList.setSelectedIndex(-1);
                    qualificationScoresList.setModel(emptyModel);
                }

                if (!currentEntity.qualificationScoresFull(roundsIndex)) {
                    qualificationScoresTextField.setEnabled(true);
                    qualificationScoresAddButton.setEnabled(true);
                } else {
                    qualificationScoresTextField.setText("");
                    qualificationScoresTextField.setEnabled(false);
                    qualificationScoresAddButton.setEnabled(false);
    ...
    private void qualificationExportButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_qualificationExportButtonMouseReleased
        if (qualificationExportButton.isEnabled()) {
            try {
    ...
    private void qualificationResetButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_qualificationResetButtonMouseReleased
        if (qualificationResetButton.isEnabled()) {
    ...
    private void qualificationSaveToggleButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_qualificationSaveToggleButtonMouseReleased
        if (qualificationSaveToggleButton.isEnabled()) {
    ...
    // Enter Handlers:
    // handling the event when the user presses enter while in participantsSchoolsTextField
    private void participantsSchoolsTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_participantsSchoolsTextFieldActionPerformed
        if (participantsSchoolsTextField.isEnabled()) {
            String newSchoolName = participantsSchoolsTextField.getText();
    ...
    }//GEN-LAST:event_participantsSchoolsTextFieldActionPerformed

    // handling the event when the user presses enter while in participantsTeachersTextField
    private void participantsTeachersTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_participantsTeachersTextFieldActionPerformed
        if (participantsTeachersAddButton.isEnabled()) {
            String newTeacherName = participantsTeachersTextField.getText();
    ...
    }//GEN-LAST:event_participantsTeachersTextFieldActionPerformed

    // handling the event when the user presses enter while in participantsStudentsTextField
    private void participantsStudentsTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_participantsStudentsTextFieldActionPerformed
        if (participantsStudentsAddButton.isEnabled()) {
            String newStudentName = participantsStudentsTextField.getText();
    ...
    }//GEN-LAST:event_participantsStudentsTextFieldActionPerformed

    // handling the event when the user presses enter while in qualificationScoresTextField
    private void qualificationScoresTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_qualificationScoresTextFieldActionPerformed
        if (qualificationScoresAddButton.isEnabled()) {
            String scoreString = qualificationScoresTextField.getText();
            ...
            if (!scoreString.equals("")) {
                try {
                    ...
                    currentEvent.incrementNumQualificationScores();
                    currentEntity.addQualificationScore(score, roundsIndex);

                    int progress = (int) currentEvent.getNumQualificationScoresPercentage();
                    this.updateQualificationProgressBar(progress);

                    if (currentEvent.getNumQualificationScores() == currentEvent.getMaxNumQualificationScores()) {
                        qualificationApproveIncompleteToggleButton.setEnabled(true);

                        if (qualification.eventsQualificationScoresCollected()) {
                            qualificationApproveCompleteToggleButton.setEnabled(true);
                        }
                    }

                    this.updateScoresListModel(currentEntity);

                    int newScoreIndex = currentEntity.getQualificationScoresListSize(roundsIndex) - 1;

                    scoresIndex = newScoreIndex;

                    qualificationScoresTextField.setText("");

                    qualificationScoresList.setEnabled(true);

                    qualificationScoresList.setSelectedIndex(newScoreIndex);
                    qualificationScoresList.ensureIndexIsVisible(newScoreIndex);

                    qualificationScoresTextField.grabFocus();

                    qualificationScoresRemoveButton.setEnabled(true);
    ...
    }//GEN-LAST:event_qualificationScoresTextFieldActionPerformed

    private void qualificationScoresAddButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_qualificationScoresAddButtonMouseReleased
        if (qualificationScoresAddButton.isEnabled()) {
            String scoreString = qualificationScoresTextField.getText();
    ...
    }//GEN-LAST:event_qualificationScoresAddButtonMouseReleased

    private void qualificationScoresRemoveButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_qualificationScoresRemoveButtonMouseReleased
        if (qualificationScoresRemoveButton.isEnabled()) {
            QualificationEvent currentEvent = qualification.getEventArrayElement(eventsIndex);
            Round currentRound = currentEvent.getRoundArrayElement(roundsIndex);
            Room currentRoom = currentRound.getRoomArrayElement(roomsIndex);
            Entity currentEntity = (Entity) currentRoom.getEntityTreeNodeData(qStudentCodesIndex);
            ...
            if (scoresIndex != -1) {
                currentEvent.decrementNumQualificationScores();
                currentEntity.removeQualificationScore(roundsIndex, qualificationScoresList.getSelectedIndex());
                ...
                if (currentEntity.qualificationScoresAllocated(roundsIndex)) {
                    ...
                    qualificationScoresList.setSelectedIndex(0);
                    qualificationScoresList.ensureIndexIsVisible(0);

                    scoresIndex = 0;
                } else {
                    qualificationScoresList.setEnabled(false); // #16
                    qualificationScoresRemoveButton.setEnabled(false);
    ...
    }//GEN-LAST:event_qualificationScoresRemoveButtonMouseReleased

    private void qualificationScoresListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_qualificationScoresListValueChanged
        // nothing actually happens here
    }//GEN-LAST:event_qualificationScoresListValueChanged
